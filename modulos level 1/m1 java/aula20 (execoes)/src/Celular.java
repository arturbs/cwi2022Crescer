public abstract class Celular {
    ...
    private final double NIVEL_CRITICO_BATERIA = 5;
    private String nome;
    ...
    protected void gastaEnergiaBateria(double energiaGasta) {
        if (this.getNivelBateria() <= NIVEL_CRITICO_BATERIA) {
            throw new NivelCriticoDaBateriaException();
        }
